...
private WebClient.Builder webClientBuilder;
    ...
    return products.stream().map(this::mapToProductDto).toList();
        ...
        private ProductQuantityDto mapToProductQuantityDto(Product product) {
            ...
            .uri("http://localhost:8083/api/inventory/{code}", product.getCode()) // after using discovery service 
            // .uri("http://inventory-service/api/inventory/{code}", product.getCode()) // .uri() specify the uri for the request 
